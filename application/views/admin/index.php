			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
                        ...
                        <li class="admin_menu_2" style="display:none">
							<a href="#" class="dropdown-toggle">
								<i class="icon-desktop"></i>
								<span class="menu-text" > admin/index </span>
						...
						<li class="admin_menu_1" style="display:none">
							<a href="#" class="dropdown-toggle">
								<i class="icon-desktop"></i>
								<span class="menu-text" > pages/view </span>
													...
													<div class="tab-content padding-8 overflow-visible">
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="<?php echo base_url('public/assets/avatars/avatar.png')?>" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="<?php echo base_url('public/assets/avatars/avatar2.png')?>" />
																	</div>
...
<![endif]-->
		...
		<script src="<?php echo base_url('public/assets/js/jquery.easy-pie-chart.min.js') ?>"></script>
		...
		<script src="<?php echo base_url('public/assets/js/flot/jquery.flot.pie.min.js') ?>"></script>
